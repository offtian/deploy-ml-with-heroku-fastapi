...
model_dir = os.path.join(os.path.abspath(os.getcwd()),  "model")  # the directory where the model will be stored.
...
performance = compute_slice_metric(classifier, "workclass", cat_features, encoder, lb, data)
